...
exports.delay = exports.getAddressesByCreatorAddress = exports.getAccountsByCreatorAddress = exports.signAllMetadataFromCandyMachine = void 0;
...
async function getAddressesByCreatorAddress(candyMachineAddr, connection) {
    const accountsByCreatorAddress = await getAccountsByCreatorAddress(candyMachineAddr, connection);
    const addresses = accountsByCreatorAddress.map(it => {
        return new web3_js_1.PublicKey(it[0].mint).toBase58();
    });
    return addresses;
}
exports.getAddressesByCreatorAddress = getAddressesByCreatorAddress;
