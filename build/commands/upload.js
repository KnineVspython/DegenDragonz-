                ...
                try {
                    switch (storage) {
                        case storage_type_1.StorageType.Pinata:
                            ...
                            break;
                        case storage_type_1.StorageType.NftStorage:
                            [link, imageLink, animationLink] = await (0, nft_storage_1.nftStorageUpload)(image, animation, manifestBuffer, walletKeyPair, env, nftStorageKey);
                            break;
