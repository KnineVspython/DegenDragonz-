...
commander_1.program
    ...
    //@ts-ignore
    const fairLaunchLotteryBitmap = (await (0, accounts_1.getFairLaunchLotteryBitmap)(fairLaunchObj.tokenMint))[0];
    await adjustTicket({
        amountNumber,
        fairLaunchObj,
...
commander_1.program
    ...
    const fairLaunchObj = await anchorProgram.account.fairLaunch.fetch(fairLaunchKey);
    //@ts-ignore
    const tokenAccount = (await (0, accounts_1.getAtaForMint)(fairLaunchObj.tokenMint, walletKeyPair.publicKey))[0];
